...
<p align="center">Figure 1: Digital wallet</p>
...
<p align="center">Figure 2: Cross-wallet balance transfer</p>
...
**Table 1 Mapping between per-node TPS and node number**
...
<p align="center">Figure 3: In-memory solution</p>
...
<p align="center">Figure 4: Relational database</p>
...
<p align="center">Figure 5: Two-phase commit (source [5])</p>
...
<p align="center">Figure 6: Coordinator crashes</p>
...
<p align="center">Figure 7: Try phase</p>
...
<p align="center">Figure 8: Confirm phase</p>
...
<p align="center">Figure 9: Cancel phase</p>
...
<p align="center">Figure 10: Phase status table</p>
...
<p align="center">Figure 11: Unbalanced state</p>
...
<p align="center">Figure 12: Out-of-order execution</p>
...
<p align="center">Figure 13: Saga workflow</p>
...
<p align="center">Figure 14: Static view of event sourcing</p>
...
<p align="center">Figure 15: Dynamic view of event sourcing</p>
...
<p align="center">Figure 16: Command queue</p>
...
<p align="center">Figure 17: How state machine works</p>
...
<p align="center">Figure 18: Reproduce states</p>
...
1. **Do we know the account balance at any given time?**  
   We could answer it by replaying events from the start, up to the point in time where we would like to know the account balance.

2. **How do we know the historical and current account balances are correct?**  
   We could verify the correctness of the account balance by recalculating it from the event list.

3. **How do we prove the system logic is correct after a code change?**  
   We can run different versions of the code against the events and verify that their results are identical.
...
<p align="center">Figure 19: CQRS architecture</p>
...
<p align="center">Figure 20: File-based command and event storage</p>
...
<p align="center">Figure 21: File-based solution for command, event, and state</p>
...
<p align="center">Figure 22: Snapshot</p>
...
<p align="center">Figure 23: Raft</p>
...
<p align="center">Figure 24: Raft node group</p>
...
<p align="center">Figure 25: Periodical pulling</p>
...
<p align="center">Figure 26: Pull model with reverse proxy</p>
...
<p align="center">Figure 27: Push model</p>
...
<p align="center">Figure 29: Final design in a numbered sequence</p>
