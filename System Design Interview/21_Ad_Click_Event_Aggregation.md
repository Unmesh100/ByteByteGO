...
<p align="center">Figure 1: RTB process</p>
...
<p align="center">Table 2: Request parameters for /v1/ads/{:ad_id}/aggregated_count</p>
...
<p align="center">Table 3: Response for /v1/ads/{:ad_id}/aggregated_count</p>
...
<p align="center">Table 4: API for /v1/ads/popular_ads</p>
...
<p align="center">Table 5: Request parameters for /v1/ads/popular_ads</p>
...
<p align="center">Table 6: Response for /v1/ads/popular_ads</p>
...
<p align="center">Table 9: Aggregated data with filters</p>
...
<p align="center">Figure 2: Aggregation workflow</p>
...
<p align="center">Figure 3: High-level design</p>
...
<p align="center">Figure 4: End-to-end exactly once</p>
...
<p align="center">Figure 5: Aggregation service</p>
...
<p align="center">Figure 6: Map operation</p>
...
<p align="center">Figure 7: Reduce node</p>
...
<p align="center">Figure 8: Aggregate the number of clicks</p>
...
<p align="center">Figure 9: Return top N most clicked ads</p>
...
| Input | User requests | Bounded input with finite size | Input has no boundary (infinite streams) |
...
<p align="center">Figure 10: Lambda and Kappa architectures</p>
...
<p align="center">Figure 11: Recalculation service</p>
...
<p align="center">Figure 12 Late events</p>
...
<p align="center">Figure 13: Miss events in an aggregation window</p>
...
<p align="center">Figure 14: Watermark</p>
...
<p align="center">Figure 15: Tumbling window</p>
...
<p align="center">Figure 16: Sliding window</p>
...
One of the most common data quality issues is duplicated data. Duplicated data can come from two common sources:
...
<p align="center">Figure 17: Duplicate data</p>
...
<p align="center">Figure 18: Record the offset</p>
...
<p align="center">Figure 19: Save offset after receiving ack</p>
...
<p align="center">Figure 20: Distributed transaction</p>
...
<p align="center">Figure 21: Add consumers</p>
...
- **Number of partitions:** If the number of partitions changes, events of the same `ad_id` might be mapped to a different partition. Therefore, it’s recommended to pre-allocate enough partitions in advance, to avoid dynamically increasing the number of partitions in production.
- **Topic physical sharding:** One single topic is usually not enough. We can Split the data by geography (`topic_north_america`, `topic_europe`, etc.) or by business type (`topic_web_ads`, `topic_mobile_ads`, etc.).
...
<p align="center">Figure 22: Aggregation service</p>
...
<p align="center">Figure 23: Multi-threading</p>
...
<p align="center">Figure 24: Virtual nodes</p>
...
<p align="center">Figure 25: Allocate more aggregation nodes</p>
...
<p align="center">Figure 26: Data in a snapshot</p>
...
<p align="center">Figure 27: Aggregation node failover</p>
...
<p align="center">Figure 28: Final design</p>
...
<p align="center">Figure 29: Alternative design</p>
