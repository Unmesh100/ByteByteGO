...
<p align="center">Figure 1: Largest stock exchanges (Source: [5])</p>
...
<p align="center">Figure 5: A single candlestick chart</p>
...
<p align="center">Figure 6: High-level design</p>
...
<p align="center">Figure 7: Inbound and outbound sequencers</p>
...
<p align="center">Figure 8: Client gateway components</p>
...
<p align="center">Figure 9: Client gateway</p>
...
<p align="center">Figure 10: Market Data Publisher</p>
...
<p align="center">Figure 11: Reporter</p>
...
| orderType | String | limit or market (note we only support limit orders in our design) |
...
| creationTime | Long | The system creation time of the order |
| filledQuantity | Long | The quantity that has been successfully executed |
| remainingQuantity | Long | The quantity still to be executed |
...
| startTime | Long | Query start time in epoch [11] |
...
| Field | Type | Description |
|-------|------|-------------|
| executions | Array | Array with each execution in scope |
...
|-----------|------|-------------|
| symbol | String | The stock symbol |
| resolution | Long | Window length of the candlestick chart in seconds |
| startTime | Long | Start time of the window in epoch |
| endTime | Long | End time of the window in epoch |
...
<p align="center">Figure 12 Product, order, execution</p>
...
<p align="center">Figure 13: Limit order book illustrated</p>
...
<p align="center">Figure 14: Place, match, and cancel an order in O(1)</p>
...
<p align="center">Figure 15: A low latency single server exchange design</p>
...
<p align="center">Figure 16: Application loop thread in Order Manager</p>
...
<p align="center">Figure 17: Non-event sourcing vs event sourcing</p>
...
<p align="center">Figure 18: An event sourcing design</p>
...
<p align="center">Figure 19: Sample design of Sequencer</p>
...
<p align="center">Figure 20: Hot-warm matching engine</p>
...
<p align="center">Figure 21: Event replication in Raft cluster</p>
...
<p align="center">Figure 22: Raft terms (Source: [23])</p>
...
<p align="center">Figure 23: Time in event sourcing</p>
...
<p align="center">Figure 24: Market Data Publisher</p>
...
- Harden URLs against DDoS attacks. For example, with a URL like `https://my.website.com/data?from=123&to=456`, an attacker can easily generate many different requests by changing the query string. Instead, URLs like this work better: `https://my.website.com/data/recent`. It can also be cached at the CDN layer.
