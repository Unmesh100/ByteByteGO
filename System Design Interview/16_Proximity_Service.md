...
<p align="center">Figure 1 Nearby search on Yelp (Source: [1])</p>
...
<p align="center">Figure 3 Two dimensional search</p>
...
<p align="center">Figure 4 Intersect two datasets</p>
...
<p align="center">Figure 5 Different types of geospatial indexes</p>
...
<p align="center">Figure 6 Global map</p>
...
<p align="center">Figure 7 Geohash</p>
...
<p align="center">Figure 8 Divide grid</p>
...
<p align="center">Figure 9 Shared prefix</p>
...
<p align="center">Figure 10 No shared prefix</p>
...
<p align="center">Figure 11 Boundary issue</p>
...
<p align="center">Figure 12 Expand the search process</p>
...
<p align="center">Figure 13 Quadtree</p>
...
<p align="center">Figure 14 Build quadtree</p>
...
<p align="center">Figure 15 Real-world example of a quadtree</p>
...
<p align="center">Figure 16 Hilbert curve (source: [24])</p>
...
<p align="center">Figure 17 Geofence</p>
...
<p align="center">Figure 18 Remove a business</p>
...
<p align="center">Figure 20 Deploy LBS closer to the user</p>
...
<p align="center">Figure 21 Design diagram</p>
...
1. The load balancer forwards the request to the LBS.
2. Based on the user location and radius info, the LBS finds the geohash length that matches the search. By checking Table 5, 500m map to geohash length = 6.
3. LBS calculates neighboring geohashes and adds them to the list. The result looks like this: `list_of_geohashes = [my_geohash, neighbor1_geohash, neighbor2_geohash, …, neighbor8_geohash]`.
4. For each geohash in `list_of_geohashes`, LBS calls the "Geohash" Redis server to fetch corresponding business IDs. Calls to fetch business IDs for each geohash can be made in parallel to reduce latency.
5. Based on the list of business IDs returned, LBS fetches fully hydrated business information from the "Business info" Redis server, then calculates distances between a user and businesses, ranks them, and returns the result to the client.
