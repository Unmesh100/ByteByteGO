...
<p align="center">Figure 1: Popular email providers</p>
...
<p align="center">Figure 2: MX records</p>
...
<p align="center">Figure 3: Traditional mail servers</p>
...
<p align="center">Figure 4: Maildir</p>
...
[{
  ...
  "name": "string",     // Name of the folder.
                        ...
                        // the following: All, Archive, Drafts, Flagged, Junk, Sent, and Trash.
...
<p align="center">Figure 5: High-level design</p>
...
<p align="center">Figure 6: Email sending flow</p>
...
<p align="center">Figure 7: Email receiving flow diagram</p>
...
5. *(Bonus point)* Get conversation threads.
...
*Table 3: `emails_by_user` and `attachments`*
...
| Column | Type | Key |
|--------|------|-----|
| email_id | TIMEUUID | Partition Key (K) |
| filename | TEXT | |
| url | TEXT | |
...
*Table 4: `read_emails` and `unread_emails`*
...
<p align="center">Figure 8: Handle feedback loop</p>
...
<p align="center">Figure 9: An example of a Gmail header</p>
...
<p align="center">Figure 10: Elasticsearch architecture</p>
...
<p align="center">Figure 11: LSM Tree</p>

*Table 7: Elasticsearch vs custom search engine*
...
<p align="center">Figure 12: Multi-data center setup</p>
